...
# 결과치는 step =100번 이하 w = 1.9999, b = 0.9999
...
optimizer = tf.train.GradientDescentOptimizer(learning_rate=0.174) #기본 제공해주는 옵티마이저 
...
#프레딕트
x_test = tf.compat.v1.placeholder(tf.float32, shape=[None]) #자리창출하지 어떤값을 갖고 있는지 모름 

linear = x_test*W_val + b_val  


print(sess.run(linear, feed_dict={x_test:[4]})) #[8.998177]
print(sess.run(linear, feed_dict={x_test:[5,6]}))  #[10.997122 12.996066]
print(sess.run(linear, feed_dict={x_test:[6,7,8]})) #[12.996066 14.99501  16.993954]
