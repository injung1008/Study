...
W = tf.Variable(tf.random_normal([1]), dtype=tf.float32, name='test') #[1] = 랜덤하게 내맘대로 넣은 초기값일뿐이다 
b = tf.Variable(tf.random_normal([1]), dtype=tf.float32, name = 'test') #초기값
#0-1 사이값을 뽑아와서 초기값을 설정해주는것 
