...
# print(f'train.shape:{train.shape}') #train.shape:(174304, 13)
# print(f'test.shape:{test.shape}') #test.shape:(43576, 12)
# print(f'train label 개수: {train.label.nunique()}') #train label 개수: 46
...
# print(train.shape) #(174304, 4)
# print(test.shape) #(43576, 3)
...
# 학습과 eval 시작
history = cls_model.fit(train_inputs, train_labels, epochs=3, batch_size=500,
