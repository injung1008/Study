...
model.fit(x_train, y_train, epochs=30, batch_size=100,  validation_split=0.02, callbacks=[es])
...
# print(temp)
# print(temp.keys()) #RangeIndex(start=0, stop=1, step=1)


temp.rename(columns={0:'topic_idx'}, inplace=True)
#temp.set_index(range(45654,94785),inplace=True)
