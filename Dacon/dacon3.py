...
test = pd.read_csv('D:\Study\_data\형준\predict.csv',sep=',',
...
# tfidf = TfidfVectorizer(analyzer='char', sublinear_tf=True, ngram_range=(1, 2), max_features=40000, binary=False)
...
# model.add(Dense(1000, input_dim=40000, activation='relu'))
...
# hist = model.fit(x, y, epochs=15,batch_size=50, validation_data=(x_val,y_val))
...
# print(temp)
# temp.to_csv('D:\Study\Dacon\_save\submission4.csv')