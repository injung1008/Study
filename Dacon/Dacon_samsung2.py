...
#read csv
import pandas as pd
train = pd.read_csv("D:\Study\_data\sam\\train.csv")
dev = pd.read_csv("D:\Study\_data\sam\dev.csv")
test = pd.read_csv("D:\Study\_data\sam\\test.csv")

ss = pd.read_csv("D:\Study\_data\sam\sample_submission.csv")
...
ss.to_csv("D:\Study\Dcon_save\pattern_mlp.csv",index=False)
