...
#2-1 모델1 구성 
input1 = Input(shape=(5,)) #input_length=5
#input1 = Input(shape=(None,))

embedding1 = Embedding(input_dim=26, output_dim=11)(input1)
embedding2 = LSTM(32)(embedding1)
embedding3 = Dense(5)(embedding2)
output1 = Dense(1, activation='sigmoid')(embedding3)
