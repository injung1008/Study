...
x1_train,x1_test,y1_train, y1_test,y2_train, y2_test = train_test_split(x1, 
...
dense2 = Dense(17, activation='relu',name='dense2')(dense1)
dense3 = Dense(15, activation='relu',name='dense3')(dense2)
output21 = Dense(7,name='abc')(dense3)
last_output1 = Dense(1,name='abcd')(output21)
#y2_train
output22 = Dense(8)(dense3)
...
# x =3 개, y= 1개 이기땜시
model.fit(x1_train, [y1_train,y2_train], epochs=1000, batch_size=8, verbose=1 )
