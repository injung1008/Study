...
from tensorflow.keras.wrappers.scikit_learn import KerasClassifier, KerasRegressor # 텐서플로우 모델을 사이킥런 모델로 인식하게 만들어주는것 
model2 = KerasRegressor(build_fn=build_model, verbose=1, validation_split=0.2)
...
# acc = model.r2_score(x_test, y_test)
# print("최종 스코어 : ", acc)
