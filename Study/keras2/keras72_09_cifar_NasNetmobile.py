...
print(x_train.shape,y_train.shape) #(500, 320, 320, 3) (500, 100)
print(x_test.shape,y_test.shape) #(100, 320, 320, 3) (100, 100)
...
inc = NASNetMobile(weights='imagenet', include_top=False, input_shape=(320,320,3))
inc.trainable=False #가중치를 동결한다 
model = Sequential()
model.add(inc)
# model.add(Flatten())
