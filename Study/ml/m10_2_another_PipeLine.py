...
# RandomForestClassifier 을 rf라고 정의를 해놨기때문에 파라미터에서도 변경을 시켜준다 
#!2. model 구성 
from sklearn.preprocessing import MinMaxScaler, StandardScaler
pipe = Pipeline([("scailer",MinMaxScaler()),( "rf",RandomForestClassifier())])
#괄호와 대괄호를 해줘야한다 이러는 이유는 별칭을 정해 줄수 있기때문이다 
