...
# print(x)
df = pd.DataFrame(x, columns=['petal_w','petal_l','sepal_w','sepal_l'])
...
#2. 모델                                                  데이터 삭제                    삭제 전 
# model = DecisionTreeClassifier(max_depth=5) #acc :  0.9111111111111111   vs  acc :  0.9111111111111111
# model = RandomForestClassifier() #acc :  0.8888888888888888  vs  acc :  0.9111111111111111
# model = GradientBoostingClassifier() #acc :  0.9111111111111111  vs  acc :  0.8888888888888888
model = XGBClassifier() #acc :  0.9111111111111111     vs  acc :  0.9111111111111111
